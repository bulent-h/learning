        ...
        <>
            <div className="relative">
                ...
                {/* <!--Image Preview --> */}
                {
                    ...
                    <div className="" >
                        <div className="bg-gray-400/50 p-2 absolute bottom-20 right-2 w-1/6 rounded-xl flex flex-col justify-center">
                            ...
                            <img id="preview" className="w-36 opacity-75 rounded-2xl" src={message.fileUrl} />
                        </div>
                    </div>
                ...
                }
                {
                    message.parent_id
                    &&
                    <div className="opacity-50 bg-gray-400/50 absolute bottom-20 w-full flex rounded-2xl">
